  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold mb-6 text-center">Family Balance Mini-Assessment</h1>
        ...
        {/* Question */}
        <div className="mb-8">
          <h2 className="text-xl mb-2">{currentQ.text}</h2>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <button 
            ...
            className="p-4 bg-purple-100 hover:bg-purple-200 rounded-lg text-center"
          >
            <span className="block font-bold text-lg text-purple-800 mb-1">Mama</span>
            <span className="text-sm text-purple-600">Click to select</span>
          </button>
          ...
          >
            <span className="block font-bold text-lg text-blue-800 mb-1">Papa</span>
            <span className="text-sm text-blue-600">Click to select</span>
          </button>
        </div>
      </div>
    </div>
